...
internal fun seedRecipesIfEmpty(repository: RecipeRepository) {
    ...
    repository.addRecipe(
        title = "Крем-брюле с кофе и карамелью",
        tags = listOf("Сладкое"),
        servings = 6,
        ingredients = listOf(
            Ingredient(name = "Жирные сливки", amount = 454.0, unit = "г"),
            Ingredient(name = "Молотый кофе", amount = 10.0, unit = "г"),
            Ingredient(name = "Мелкая соль", amount = 0.5, unit = "ч.л."),
            Ingredient(name = "Сахар", amount = 100.0, unit = "г"),
            Ingredient(name = "Яичный желток", amount = 4.0, unit = "шт"),
            Ingredient(name = "Ванильный экстракт", amount = 1.0, unit = "ч.л."),
            Ingredient(name = "Сахар для карамелизации (посыпки)", amount = 3.0, unit = "ст.л."),
        ),
        steps = listOf(
            Step(
                order = 1,
                text = "Подогреть сливки, кофе и соль на среднем огне почти до кипения, снять с огня и дать настояться",
                timerSeconds = 1200,
            ),
            Step(order = 2, text = "Сварить сахар в кастрюле на медленном огне до светло-янтарной карамели", timerSeconds = null),
            Step(
                order = 3,
                text = "Медленно процедить кофейные сливки в карамель через сито, дать остыть до тёплого состояния",
                timerSeconds = null,
            ),
            Step(order = 4, text = "Влить кофейно-карамельный крем в желтки, постоянно помешивая", timerSeconds = null),
            Step(order = 5, text = "Добавить ванильный экстракт", timerSeconds = null),
            Step(order = 6, text = "Разлить по формочкам в форме для запекания", timerSeconds = null),
            Step(
                order = 7,
                text = "Поставить форму в разогретую до 163°C духовку, налить горячей воды на треть высоты формочек (водяная баня)",
                timerSeconds = null,
            ),
            Step(order = 8, text = "Выпекать, пока крем не будет чуть колыхаться при постукивании", timerSeconds = 1500),
            Step(order = 9, text = "Остудить на столе, затем убрать в холодильник минимум на 4 часа", timerSeconds = 1200),
            Step(order = 10, text = "Посыпать тонким слоем сахара и карамелизовать горелкой или под грилем", timerSeconds = null),
        ),
        notes = "Для карамелизации верха понадобится кулинарная горелка либо режим гриля/верхнего нагрева " +
            "в духовке. После выпечки крему нужно постоять в холодильнике минимум 4 часа — учитывай это по времени.",
    )
}
